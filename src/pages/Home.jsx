  ...
  return (
    <div className="w-full max-w-7xl mx-auto pb-20">
      ...
      <div className="mt-6 grid grid-cols-3 gap-6 px-10 place-items-center max-lg:hidden">
        <img
          alt=""
          src="/images/Horizental_1_D.webp"
          className="w-auto h-auto object-center object-cover rounded-sm"
        />

        <img
          alt=""
          src="/images/Horizental_2_D.webp"
          className="w-auto h-auto object-center object-cover rounded-sm"
        />

        <img
          alt=""
          src="/images/Horizental_3_D.webp"
          className="w-auto h-auto object-center object-cover rounded-sm"
        />
      </div>
      ...
      <div className="w-full mt-14 px-4 lg:px-10">
        ...
        >
          <div className="w-full grid grid-cols-2 lg:grid-cols-3 gap-4">
            <BlogPostCard_1
              img="/images/blog-post-img-1.jpg"
            ...
            <BlogPostCard_1
              img="/images/blog-post-img-2.jpg"
            ...
            <BlogPostCard_1
              img="/images/blog-post-img-3.jpg"
